...
{
    public class DbAccessorService : IDbAccessorService
    {
        private readonly ApplicationDbContext _context;
        public DbAccessorService(ApplicationDbContext context)
        {
            _context = context;
        }
        public async Task<int> GetTotalstudentCount()
        {
            return await _context.StudentsPortalInfos.CountAsync();
        }
